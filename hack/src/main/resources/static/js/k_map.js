...
const searchInput = document.getElementById("dsearch-location");
const searchResults = document.getElementById("dsearch-results");
...
searchInput.addEventListener("input", async (e) => {
  ...
  if (query.length > 1) {
    ...
    searchResults.innerHTML = ""; // 입력이 적을 때는 자동완성 숨김
  }
});
...
searchButton.addEventListener("click", () => {
  ...
  console.log("검색된 주소:", query);
  // 여기에 검색 결과 처리 로직 추가
});

// 버튼 및 모달 요소 가져오기
const openSangBtn = document.getElementById("opensang");
const openMenuBtn = document.getElementById("openmenu");
const openkeyBtn = document.getElementById("openkey");

const mapPopup = document.getElementById("map-popup");
const menuPopup = document.getElementById("menu-popup");
const kPopup = document.getElementById("k-popup");

const closereModalBtn = document.getElementById("closereModalBtn");
const closeMapModalBtn = document.getElementById("closeMapModalBtn");
const closeMenuModalBtn = document.getElementById("closeModalBtn");
const closekeyModalBtn = document.getElementById("closekeyModalBtn");

document.getElementById("opensang2").addEventListener("click", function () {
  // map-popup2 요소를 찾고, display를 block으로 설정하여 보이게 만듬
  document.getElementById("map-popup2").style.display = "flex";
});
// 버튼 클릭 이벤트로 모달 열기
openSangBtn.addEventListener("click", function () {
